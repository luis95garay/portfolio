...
<table>
  <tr>
    ...
    <td>
      ...
      <p><strong>Portfolio:</strong> <a href="https://portfolio-bjgvz2pnla-uc.a.run.app/">https://portfolio-bjgvz2pnla-uc.a.run.app/</a></p>
    </td>
  </tr>
</table>
...
## 3) Agricultural Crop Image Classification with Deep Learning
...
- Tools: PyTorch, Python, mlflow, FastAPI.
  [Image classification](https://github.com/luis95garay/agricultural_crops_detection)
  ![accuracy](public/accuracy_overall.png)

  ![test](public/test.png)

## 4) Sentiment Analysis for Amazon Reviews

- This project focuses on developing and evaluating an API for sentiment analysis specifically tailored for Amazon reviews. Our goal is to compare the performance of various fine-tuning configurations of the BERT model.
- Tools: PyTorch, MLflow, Hugging Face Transformers, NLTK, and Scikit-learn.
  [Sentiment Analysis](https://github.com/luis95garay/nlp_amazon_reviews)

  ![Sentiment Analysis](public/positive_e.png)

  ![accuracy](public/metrics1_sentiment.png)

## 5) Object Detection for Stock Detection in an Automatic Store
...
## 6) Time Series Analysis for Mauna Loa CO2 Concentration
...
## 7) Clustering and Visualization for Gene Analysis
...
## 8) Graph theory in criminal network
